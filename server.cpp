...
int main() {
  ...
  // 2nd & 3rd args sets optons, 4th sets option value. SO_REUSEADDR reuses the
  // same port as the last instance
  int val = 1;
  ...
  // listen
  // SOMAXCONN is 4096 on Linux. The second argument for listen is the sizeof
  // queue
